...
df_years = dfSerieA.groupby("year")
Filtr = dfSerieA[dfSerieA["league"] == "Serie_A"]

media_goles = dfSerieA.groupby("year")[['xG', 'scored', 'xG_diff']].mean()
partidos_por_año = dfSerieA.groupby("year").size()
...
tabla.to_csv("SerieA_resumen.csv", index=False)
